 ...
 * DBInterdave} for performing a insert operation.
 * 
 * @author bs2113
 * 
 */
public interface SQLInsert {
  ...
  /**
   * Formats the {@link java.sql.PreparedStatement PreparedStatement} made from {@link #getSQLInsert() getSQLInsert} with the
   * required parameters.
   * 
   * @param prepared
